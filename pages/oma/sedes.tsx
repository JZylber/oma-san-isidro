...
const OMAVenues : NextPage<{next_instance: string,venues: Venue<School>[],dropPoints: DropPoint [], auth_max_date: string,participants: Participant<School>[]}> = ({next_instance,venues,dropPoints,auth_max_date,participants}) => {
