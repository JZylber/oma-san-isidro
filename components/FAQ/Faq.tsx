...
export default function Faq(){
    ...
    <div className={styles.container}>
        ...
        <FaqItem question='¿Qué partidos forman parte de la región?' answer='La secretaría regional San Isidro comprende los partidos de Vicente López, San Isidro, San Fernando, Don Torcuato, Tigre, Malvinas Argentinas, San Miguel y José C.Paz.'></FaqItem>
