  ...
  return (
    <div className="flex flex-col gap-y-4">
      ...
      <p className="font-monserrat text-2xl">
        ...
        <span className="font-bold">.xlsx</span>. Este debe contener la primera
        fila los nombres de las columnas y los resultados en las subsiguientes
        filas. Además, debe contar con las siguientes columnas:
      </p>
