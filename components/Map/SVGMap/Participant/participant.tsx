...
const Participant = ({school,level, id,size = 40, selected = false}: ParticipantProps) => {
    const backgroundColor = selected?"#D9F5FC":"#FEFDF3";
    const color = "#000000"
    return (
        <div className='relative' style={{width:size,height:size}}>
        <svg data-tooltip-id={id} width="100%" height="100%" viewBox="0 0 400 400" fill={backgroundColor}>
            <rect x="2.5" y="2.5" width="395" height="395" rx="33.5" stroke={color} strokeWidth="5"/>
            ...
            <rect x="247.5" y="247.5" width="120" height="120" rx="60" stroke={color} strokeWidth="15"/>
