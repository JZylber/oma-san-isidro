    ...
    return(
        <div className={styles.container}>
            ...
            {!isMobile && <form className={styles.filters}>
                <SelectResultCategory category="Participante" value={filters.participante} setValue={(value?: Participant) => updateFilter({participante:value})} options={names} input={true}/>
