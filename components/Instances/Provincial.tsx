...
const Provincial = ({competition, participants,auth_max_date}: ProvincialProps) => {
    ...
    return(
        ...
        <Collapsable title="Información general y programa">
            <p className={styles.text}>El encuentro de la <span className={styles.bold}>Olimpíada Regional {isOma?"Urbana":"Ñandú"} Metropolitana</span> se realizará en la ciudad de {isOma?"Mar del Plata":"Mar del Plata"} los días {isOma?"25, 26 y 27 de septiembre":"14, 15 y 16 de agosto"}. Cada delegación se trasladará por su cuenta y riesgo, con sus profesores acompañantes según las pautas establecidas <span className={styles.bold}>(máximo 8 alumnos por cada docente)</span>. También, como en años anteriores, nos ocuparemos del alojamiento y concentración de aquellas delegaciones que lo soliciten.</p> 
            ...
            <p className={styles.text}>Actividades en salones del Hotel Sheraton. {!isOma && "La organización <span className={styles.bold}>NO CONTEMPLA</span> alojamiento en el Hotel Sheraton, allí sólo se desarrollarán las actividades académicas."}</p></>}
            <h4 className={styles.section_title}>Programa</h4>
            <ul className={styles.text}>
                <li><span className={styles.bold}>Acreditación:</span> {isOma?"Miércoles 25 de septiembre":"Miércoles 14 de agosto"} de 15:00 a 20:00 horas en el hotel asignado a su delegación</li>
                <li><span className={styles.bold}>Prueba escrita:</span> {isOma?"Jueves 26 de septiembre a las 9:00 horas, Salones Sheraton Hotel - Mar del Plata":"Jueves 15 de agosto a las 9:00 horas, Salones Sheraton Hotel - Mar del Plata"}</li>
                <li><span className={styles.bold}>Exposición Oral y Premiación:</span> {isOma?"Viernes 27 de septiembre a las 9:00 horas, Salones Sheraton Hotel - Mar del Plata":"Viernes 16 de agosto a las 9:00 horas, Salones Sheraton Hotel - Mar del Plata"}</li>
            </ul>
        </Collapsable>
        <Collapsable title="Aranceles">
        <ul className={styles.text}>
            <li><span className={styles.bold}>Participantes y/o acompañantes que se alojen en el hotel propuesto por la olimpíada:</span> {isOma?"$240.000":"$235.000"}. Incluye desde la cena del día miércoles {isOma?25:14} al almuerzo del viernes {isOma?27:16} (incluye una bebida por comida).</li>
            <li><span className={styles.bold}>Participantes que NO se alojen en el hotel propuesto por la olimpíada:</span> {isOma?"$85.000":"$80.000"}.</li>
            <li><span className={styles.bold}>Acompañantes que NO se alojen en el hotel propuesto por la olimpíada:</span> {isOma?"$65.000":"$60.000"}. (menores de 3 años no pagan)</li>
            <li><span className={styles.bold}>Tarjeta de premiación:</span> {isOma?"$25000":"$20.000"}. Solo es necesaria la tarjeta para aquellos que no están acreditados como acompañantes y que participarán únicamente de la premiación. Deben inscribirse junto con los otros participantes en la planilla. Menores de 3 años no pagan. <span className={styles.bold}>CUPOS LIMITADOS</span></li>
        </ul>
        <Warning>
        ...
        <Collapsable title="Premiación">
            ...
            <p className={styles.text}> Costo de la tarjeta {isOma?"$25000":"$20.000"}.- CUPOS LIMITADOS (menores de 3 años no pagan)  </p>
        </Collapsable>
        <Collapsable title="Participantes Clasificados">
        {isOma?<p className={styles.text}>Los participantes que clasifican a la instancia provincial son aquellos que sumen 5 puntos entre las instancias Zonal e Interescolar.</p>:<p className={styles.text}>Los participantes que clasifican a la instancia provincial son aquellos que sumen 5 puntos entre las instancias Zonal e Interescolar.</p>}
        ...
        <Collapsable title="Reglamento">
            <ul className={styles.text}>
                <li>Toda otra persona (padre, tutor, etc.) que desee integrar la delegación debe comprometerse a cumplir todas las normas establecidas para la delegación.</li> <li>Los que solicitaron alojamiento en las secretarías regionales, podrán hacerlo a partir de las 15:00 horas del día {isOma?"25 de septiembre":"14 de agosto"}.</li>
                <li>Solo podrá asistir a las actividades programadas dentro de los espacios establecidos (esto incluye el ingresar, permanecer y circular por el mismo) quien se acredite debidamente el día {isOma?"25 de septiembre":"14 de agosto"}.</li>
